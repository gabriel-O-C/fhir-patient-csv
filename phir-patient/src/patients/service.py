...
def map_to_fhir_patient_from_json(patient_csv) -> Patient:
    ...
    if patient_csv.observation:
        create_observations_and_conditions(patient_id, patient_csv.observation)
...
def process_patient(patient):
    ...
    return map_to_fhir_patient_from_json(patient_csv).as_json()
